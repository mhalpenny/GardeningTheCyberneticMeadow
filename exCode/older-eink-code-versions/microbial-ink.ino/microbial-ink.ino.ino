...
#define RST_PIN 26
#define CS_PIN 15
#define Threshold 05 /* Greater the value, more the sensitivity */
...
//    display.setCursor(display.width() - tbw - 40, 20 + FreeMono9pt7b.yAdvance);
...
//      l_line = l.SDFile.readStringUntil('\n');
//      if (l_line) == ' '){
//        break;
//      }
//    }
